...
class AC_Device():
    ...
    def __init__(self, device_id, room):
        ...
        #DEFINE THE DEVICE ID TOPIC i.e., update the value of self._DEVICE_ID_TOPIC HERE
        self._DEVICE_ID_TOPIC = ""
        #DEFINE THE ROOM TOPIC i.e., update the value of self._ROOM_TOPIC HERE
        self._ROOM_TOPIC = ""
